...
const cobrancaCartaoModel = banco.define('cobranca_cartao', {
    ...
    status: { type: DataTypes.ENUM('processando', 'pendente', 'sucesso', 'falha'), allowNull: false, defaultValue: 'processando' },
    motivo_erro: { type: DataTypes.STRING, allowNull: true },
