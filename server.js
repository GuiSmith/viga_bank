...
import cobrancaCartaoRoutes from './routes/cobrancaCartaoRoutes.js'; // Importa as rotas de cobrança com cartão
...
app.use('/cobranca-cartao', cobrancaCartaoRoutes); // Adiciona as rotas de cobrança com cartão
